vmaig.com 网站源码
=================
[![ENV](https://img.shields.io/badge/python-2.7%2C3.4-blue.svg)](https://github.com/billvsme/swint_blog)
[![LICENSE](https://img.shields.io/badge/license-BSD-blue.svg)](https://github.com/billvsme/swint_blog/blob/master/LICENSE)
[![Travis](https://img.shields.io/travis/billvsme/swint_blog.svg)](https://travis-ci.org/billvsme/swint_blog)
[![Docker Stars](https://img.shields.io/docker/stars/billvsme/swint_blog.svg)](https://hub.docker.com/r/billvsme/swint_blog/)
[![Docker Pulls](https://img.shields.io/docker/pulls/billvsme/swint_blog.svg)](https://hub.docker.com/r/billvsme/swint_blog/)
# 有问题欢迎加qq群
vmaig qq群: 458788510  
我的qq: 994171686  

[使用Docker部署swint_blog](http://vmaig.com/article/deplay_swint_blog.html)

# 更新日志
2015/5/15 从django1.6 升级到 django1.8 (还保留django1.6分支)  
2015/6/21 添加[xadmin分支](https://github.com/billvsme/swint_blog/tree/xadmin),xadmin分支中使用xadmin作为后台管理(使用 django 1.8),如果你想后台比较漂亮可以切换到xadmin分支(注意你不需要pip install django-xadmin 但是需要安装django-crispy-forms跟django-reversion详细步骤见xadmin分支中的README)  
...
下载代码,切换目录 :
    ...
    git clone https://github.com/billvsme/swint_blog
    cd swint_blog
...
使用docker部署，首先pull下来image或者自己使用项目中Dockerfile或者Dockerfile_cn build。
	...
	sudo docker pull billvsme/swint_blog
然后运行image  
	例子:
